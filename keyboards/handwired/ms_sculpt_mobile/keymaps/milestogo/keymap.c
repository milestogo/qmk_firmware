...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ____, ____________BABBLE_SWITCH_L________________, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,\
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,\
    ____, __________40___SYM_NUM_L1__________________, ___________________SYM_R1__________________, ____, ____, ____,\
    ____, __________40___SYM_NUM_L2__________________, ___________________SYM_R2__________________, KC_GRV, ____, ____,\
    ____, __________40___SYM_NUM_L3__________________, ___________________SYM_R3__________________, ____, ____, ____,\
    ...
    ____, __________40_______MOV_L2__________________, __________40_______MOV_R2__________________, KC_GRV, ____, ____,\
   ...
   [_DMOV] = LAYOUT_local_wrap(\
    ...
    ____, ____________40__DELMOV_L2__________________, ____________40__DELMOV_R2__________________, KC_GRV, ____, ____,\
...
#define LED_CAPS 3    // caps on/off
#define LED_MACRO 0 // babble os indicator: windows/chrome/mac/linux
// defined as LED_INDEX =0 in config.h  in order to share modeswitch_user file
...
void babble_modeswitch_kb(uint8_t bmode) {
  babble_modeswitch_user(bmode);
